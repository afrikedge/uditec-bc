/// <summary>
/// Page A01 ShipToAdressMediaFactbox (ID 50027).
/// </summary>
page 50027 "A01 ShipToAdressMediaFactbox"
{
    ApplicationArea = All;
    Caption = 'Images';
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            field("A01 Ground plan"; Rec."A01 Ground plan")
            {
                ApplicationArea = All;
                ShowCaption = false;
            }
        ...
        area(processing)
        {
            action(ImportPicture)
            {
                ...
                begin
                    ...
                    if Rec."A01 Ground plan".HasValue() then
            ...
            action(ExportFile)
            {
                ...
                begin
                    ...
                    if not Rec."A01 Ground plan".HasValue then
                        exit;

                    if TenantMedia.Get(Rec."A01 Ground plan".MediaId) then begin
    ...
    begin
        DeleteExportEnabled := Rec."A01 Ground plan".HasValue;
    end;
}
