/// <summary>
/// Page A01 Cash Receipt Doc Journal (ID 50033).
/// </summary>
page 50033 "A01 Cash Receipt Doc Journal"
{
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("A01 Payment Doc Type"; Rec."A01 Payment Doc Type")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("A01 Check No."; Rec."A01 Check No.")
                {
                    ApplicationArea = Basic, Suite;
                    //ToolTip = 'Specifies the total amount (including VAT) that the journal line consists of.';
                    //Visible = AmountVisible;
                }
                field("A01 Check Date"; Rec."A01 Check Date")
                {
                    ApplicationArea = Basic, Suite;
                }
