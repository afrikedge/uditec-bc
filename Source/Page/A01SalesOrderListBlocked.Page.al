/// <summary>
/// Page AFK01 Sales Order List Blocked (ID 50005).
/// </summary>
page 50005 "A01 Sales Order List Blocked"
{
    ApplicationArea = All;
    Caption = 'Sales Order List - Blocked';
    PageType = List;
    SourceTable = "Sales Header";
    CardPageId = "A01 Sales Order - Workflow";
    Editable = false;
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::Blocked));
    UsageCategory = Lists;
