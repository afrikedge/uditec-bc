/// <summary>
/// Page A01 SalesOrderList-PConsigned (ID 50015).
/// </summary>
page 50015 "A01 SalesOrderList-PConsigned"
{
    ApplicationArea = All;
    Caption = 'Sales Order List - Partially Consigned';
    PageType = List;
    SourceTable = "Sales Header";
    CardPageId = "A01 Sales Order - workflow";
    Editable = false;
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::"Partially Consigned"));
    UsageCategory = Lists;
