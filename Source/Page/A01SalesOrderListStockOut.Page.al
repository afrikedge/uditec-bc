/// <summary>
/// Page A01 SalesOrderList-StockOut (ID 50006).
/// </summary>
page 50006 "A01 SalesOrderList-StockOut"
{
    ApplicationArea = All;
    Caption = 'Sales Order List - Stock Out';
    PageType = List;
    SourceTable = "Sales Header";
    CardPageId = "A01 Sales Order - workflow";
    Editable = false;
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::"Stock out"));
    UsageCategory = Lists;
