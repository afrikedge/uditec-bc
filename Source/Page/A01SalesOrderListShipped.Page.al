/// <summary>
/// Page A01 SalesOrderList-Shipped (ID 50010).
/// </summary>
page 50010 "A01 SalesOrderList-Shipped"
{
    ApplicationArea = All;
    Caption = 'Sales Order List - Totally shipped';
    PageType = List;
    SourceTable = "Sales Header";
    CardPageId = "A01 Sales Order - workflow";
    Editable = false;
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::"Totally shipped"));
    UsageCategory = Lists;
