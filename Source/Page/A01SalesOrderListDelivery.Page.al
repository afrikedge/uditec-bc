/// <summary>
/// Page A01 SalesOrderList-Delivery (ID 50009).
/// </summary>
page 50009 "A01 SalesOrderList-Delivery"
{
    ApplicationArea = All;
    Caption = 'Sales Order List - Waiting for delivery';
    PageType = List;
    SourceTable = "Sales Header";
    CardPageId = "A01 Sales Order - workflow";
    Editable = false;
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::"Waiting for delivery"));
    UsageCategory = Lists;
