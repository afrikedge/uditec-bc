/// <summary>
/// Page AFK01 SalesOrders-Draft (ID 50001).
/// </summary>
page 50002 "A01 Sales Order - Workflow"
{
    Caption = 'Sales Order';
    PageType = Document;
...
#pragma warning restore
    ...
    var
        ...
        Text10800: Label 'There are unposted prepayment amounts on the document of type %1 with the number %2.', Comment = '%1=type;%2=number';
        Text10801: Label 'There are unpaid prepayment invoices related to the document of type %1 with the number %2.', Comment = '%1=type;%2=number';
        Text001: Label 'Do you want to change %1 in all related records in the warehouse?', Comment = '%1=field';
    ...
    begin
        CalculateShipToBillToOptions();//updated
    end;
    ...
    begin
        ...
        ShipToNameEqualsSellToName :=
          (Rec."Ship-to Name" = Rec."Sell-to Customer Name") and (Rec."Ship-to Name 2" = Rec."Sell-to Customer Name 2");

        case true of
            (Rec."Ship-to Code" = '') and ShipToNameEqualsSellToName and Rec.ShipToAddressEqualsSellToAddress():
                ShipToOptions := ShipToOptions::"Default (Sell-to Address)";
            (Rec."Ship-to Code" = '') and
          (not ShipToNameEqualsSellToName or not Rec.ShipToAddressEqualsSellToAddress()):
                ShipToOptions := ShipToOptions::"Custom Address";
            Rec."Ship-to Code" <> '':
