/// <summary>
/// Page A01 SalesOrderList-PInvoiced (ID 50013).
/// </summary>
page 50013 "A01 SalesOrderList-PInvoiced"
{
    ApplicationArea = All;
    Caption = 'Sales Order List - Partially invoiced';
    PageType = List;
    SourceTable = "Sales Header";
    CardPageId = "A01 Sales Order - workflow";
    Editable = false;
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::"Partially invoiced"));
    UsageCategory = Lists;
