/// <summary>
/// Page A01 Sales Orders - Cancelled (ID 50016).
/// </summary>
page 50016 "A01 Sales Orders - Cancelled"
{
    ApplicationArea = All;
    Caption = 'Sales Orders - Cancelled';
    Editable = false;
    PageType = List;
    SourceTable = "Sales Header Archive";
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::Cancelled));
    UsageCategory = Lists;
