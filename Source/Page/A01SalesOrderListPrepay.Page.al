/// <summary>
/// Page AFK01 Sales Order - Prepay (ID 50004).
/// </summary>
page 50004 "A01 Sales Order List Prepay"
{
    ApplicationArea = All;
    Caption = 'Sales Orders - Waiting for prepayment';
    PageType = List;
    SourceTable = "Sales Header";
    CardPageId = "A01 Sales Order - Workflow";
    Editable = false;
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::"Waiting for prepayment"));
    UsageCategory = Lists;
