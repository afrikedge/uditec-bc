/// <summary>
/// Page A01 Sales Orders - Closed (ID 50017).
/// </summary>
page 50017 "A01 Sales Orders - Closed"
{
    ApplicationArea = All;
    Caption = 'Sales Orders - Closed';
    Editable = false;
    PageType = List;
    SourceTable = "Sales Header Archive";
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::Closed));
    UsageCategory = Lists;
