/// <summary>
/// Page A01 SalesOrderList-Consigned (ID 50014).
/// </summary>
page 50014 "A01 SalesOrderList-Consigned"
{
    ApplicationArea = All;
    Caption = 'Sales Order List - Consigned';
    PageType = List;
    SourceTable = "Sales Header";
    CardPageId = "A01 Sales Order - workflow";
    Editable = false;
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::Consigned));
    UsageCategory = Lists;
