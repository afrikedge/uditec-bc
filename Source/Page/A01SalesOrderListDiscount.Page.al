/// <summary>
/// Page A01 SalesOrderList-Discount (ID 50008).
/// </summary>
page 50008 "A01 SalesOrderList-Discount"
{
    ApplicationArea = All;
    Caption = 'Sales Order List - Waiting for discount';
    PageType = List;
    SourceTable = "Sales Header";
    CardPageId = "A01 Sales Order - workflow";
    Editable = false;
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::"Waiting for discount"));
    UsageCategory = Lists;
