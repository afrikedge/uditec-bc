/// <summary>
/// Page A01 Sales Orders - Invoiced (ID 50018).
/// </summary>
page 50012 "A01 Sales Orders - Invoiced"
{
    ApplicationArea = All;
    Caption = 'Sales Orders - Invoiced';
    Editable = false;
    PageType = List;
    SourceTable = "Sales Header Archive";
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::"Totally invoiced"));
    UsageCategory = Lists;
