...
/// </summary>
page 50001 "A01 SalesOrderList-Draft"
{
    ApplicationArea = All;
    Caption = 'Sales Orders - Draft';
    PageType = List;
    SourceTable = "Sales Header";
    CardPageId = "A01 Sales Order - Draft";
    Editable = false;
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::Draft));
    UsageCategory = Lists;
