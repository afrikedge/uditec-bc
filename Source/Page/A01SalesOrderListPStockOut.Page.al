/// <summary>
/// Page A01 SalesOrderList-PStockOut (ID 50007).
/// </summary>
page 50007 "A01 SalesOrderList-PStockOut"
{
    ApplicationArea = All;
    Caption = 'Sales Order List - Partially Stock Out';
    PageType = List;
    SourceTable = "Sales Header";
    CardPageId = "A01 Sales Order - workflow";
    Editable = false;
    SourceTableView = where("Document Type" = const(Order), "A01 Processing Status" = const("A01 SO Processing Status"::"Partially out of stock"));
    UsageCategory = Lists;
