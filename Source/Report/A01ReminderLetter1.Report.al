...
report 50018 "A01 Reminder Letter 1"
{
    ...
    var
        ...
        RemainingAmt: Text;
        BodyLabel01: Label 'Sauf erreur ou omission de notre part, nous n’avons pas reçu, à ce jour, le paiement d’un montant de %1 Ar (%2 ariary). Ce montant correspond au total de vos impayés et des frais de retard, relatifs à l’achat à crédit que vous avez effectué auprès de notre société, dont vous trouverez ci-dessous les détails :', Comment = '%1=...,%2=...';
        BodyLabelText: Text;
        DueDays: Integer;
