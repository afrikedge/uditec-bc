/// <summary>
/// Report A01 InventoryReportPrint (ID 50015).
/// </summary>
report 50015 "A01 InventoryReportPrint"
{
    DefaultLayout = RDLC;
    Caption = 'A01 Inventory report print';
    PreviewMode = PrintLayout;
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = './Source/Report/Layout/InventoryReportPrint.rdl';
    ...
    dataset
    {
        dataitem(PageLoop; "Integer")
        {
            ...
            dataitem("Item Journal Batch"; "Item Journal Batch")
            {
                ...
                column(DocumentNumberLbl; DocumentNumberLbl)
                {
                }
                column(UnitAmountLbl; UnitAmountLbl)
                {
                }
