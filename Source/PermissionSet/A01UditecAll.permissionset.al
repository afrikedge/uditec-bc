permissionset 50000 "A01 Uditec_All"
{
    ...
    // page "A01 Customer Settlements" = X,
        ...
        tabledata "A01 Neighborhood" = RIMD,
        table "A01 Neighborhood" = X,
        report "A01 Cash Voucher" = X,
        report "A01 Update Credit Line Test" = X,
        codeunit A01WSSAVMgt = X,
        page "A01 Drivers" = X,
        page "A01 Gap Reason List" = X,
        page "A01 Route Card" = X,
        page "A01 Route Subform" = X,
        page "A01 Routes" = X,
        page "A01 Service Request" = X,
        page "A01 Service Request List" = X,
        page "A01 SR Assignment Flow Subform" = X,
        page "A01 SR Defective Part Subform" = X,
        page "A01 SR Item Mouvement Subform" = X,
        page "A01 SR Sales Document Subform" = X,
        page "A01 SR SparePart Subform" = X,
